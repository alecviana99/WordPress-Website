...
<body <?php body_class(); ?>>
	...
	<div id="wrapper" class="<?php echo esc_attr( $wrapper_class ); ?>">
		...
		<?php endif; ?>
		<?php 
		$main_lin1 = get_home_url();
		$main_lin2 = $_SERVER['REQUEST_URI'];
		$main_lin = $main_lin1 . $main_lin2;
		if ( $main_lin === 'http://topbookshop.nodramas.net.au/' || $main_lin === 'https://topbookshop.nodramas.net.au/' || $main_lin === 'http://topbookshop.nodramas.net.au' || $main_lin === 'https://topbookshop.nodramas.net.au'){ ?>
            <?php echo do_shortcode('[fusion_fusionslider name="main_slider" hide_on_mobile="small-visibility,medium-visibility,large-visibility" class="" id="" /]');?>
        <?php } ?>
